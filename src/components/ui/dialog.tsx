...
>(({ className, children, ...props }, ref) => {
  // Quando o consumidor não fornece aria-describedby explícito, passamos
  // undefined explícito para silenciar o warning do Radix sem perder
  // acessibilidade dos diálogos que já têm DialogDescription.
  const describedBy =
